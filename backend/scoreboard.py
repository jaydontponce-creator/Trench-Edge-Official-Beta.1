...
def _shell_card(g:Dict[str,Any])->Dict[str,Any]:
    ...
    return {
        ...
        "venue_city":_first(g,"venue_city","venueCity","city"),
        "venue_state":_first(g,"venue_state","venueState","state"),
        "venue_city":_first(g,"venue_city","venueCity","city"),
        "venue_state":_first(g,"venue_state","venueState","state"),
            ...
            try:
                ...
                for raw in rows:
                    ...
                    if key in by_key:
                        ...
                        for fld in ("kickoff","venue","venue_city","venue_state","branding"):
